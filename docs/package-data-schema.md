...
```jsonc
{
  ...
  "images": [                             // string[]: path relative to src/assets/images/packages/
  ...
  "boatSpecs": [                          // array, optional: boat packages only
    ...
    { "label": "Peralatan Keselamatan", "value": "Liferaft, Life Jacket, Ring Buoy, Fire Extinguisher, First Aid Kit" },
  ...
  "cabins": [                             // array, optional: boat packages only
    {
  ...
  "priceList": {                          // object, optional: boat packages only, reference data (not consumed by generator)
...
```jsonc
{
  "id": {
    ...
    "durationOptions": [                             // REQUIRED for multi-duration
    ...
    "itinerary": {                                  // REQUIRED - object with duration keys
      "1D": [
  ...
  "ms": { /* same structure, translated to Malay */ },
  "ar": { /* same structure, translated to Arabic */ },
  "zh": { /* same structure, translated to Chinese (Simplified) */ }
}
```
