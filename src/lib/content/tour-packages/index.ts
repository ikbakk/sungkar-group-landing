export const packagePageContent = {
  ...
  cta: {
    ...
    description:
      "Tim kami dapat membantu merekomendasikan itinerary berdasarkan jumlah peserta, durasi perjalanan, dan destinasi yang ingin dikunjungi.",
    button: {
      label: "Konsultasi Perjalanan",
      href: "/kontak",
    },
  },
