...
export const accommodationsData = [
  ...
  },
  {
    ...
    region: "labuan-bajo",
    perks: ["وصول لكومودو", "دليل تخييم", "خدمات الحديقة", "جولات تصوير"],
    regionalHighlights: [
  ...
  },
  {
    ...
    region: "lombok",
    perks: ["شاطئ خاص", "رياضات مائية", "مسبح لا متناهي", "سبا وعافية"],
    regionalHighlights: [
  ...
  },
  {
    ...
    region: "lombok",
    perks: ["وصول لجزر جيلي", "رحلات بالقارب", "مركز غوص", "جولات الجزر"],
    regionalHighlights: [
  ...
  },
  {
    ...
    region: "lombok",
    perks: ["إطلالة جبلية", "دليل تخييم", "من المزرعة للمائدة", "تقليدي"],
    regionalHighlights: [
  ...
  },
  {
    ...
    name: "Lombok Mountain Retreat",
    region: "lombok",
    perks: ["山景", "徒步向导", "从农场到餐桌", "传统体验"],
    regionalHighlights: ["位于特特巴图，坐拥山景", "靠近梯田", "附近朱昆瀑布"],
